...
ParkingVision is a dashboard concept that aims to reduce the cost of parking monitoring systems in Singapore by up to 90%! It utilizes YOLO Model v4 via the PeekingDuck's pipeline to detect vehicles as well as parking lots. 

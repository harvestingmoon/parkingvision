...
app.layout = html.Div(children=[
    html.Div([
        ...
        dcc.Dropdown(dates,value ='2022-03-10', id = 'date_dropdown'),
    ...
    html.Div([
        html.Div([ # to check on why this is not working ??
        ...
        html.Div([
            dcc.Graph(
        id='example-graph')
        ], id = 'graph-container') # this one links towards the output id,
    ], id = 'right-container')
])
